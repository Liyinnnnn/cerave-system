            ...
            <div class="max-w-md w-full p-8">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div class="flex justify-between items-center text-sm">
                        ...
                        <a href="{{ route('password.request') }}" class="text-blue-600 hover:text-blue-700 font-semibold dark:text-blue-400 dark:hover:text-blue-300">Forgot Password?</a>
                    </div>
                ...
                <p class="text-center text-sm mt-4 dark:text-blue-200">Don't have an account? <a href="{{ route('register') }}"
