            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    <div>
                        <a href="{{ route('dashboard') }}" class="block mb-6">
                            <img src="{{ asset('images/CeraVeLogo.webp') }}" alt="CeraVe Logo" class="h-12">
                        </a>
                        <p class="text-gray-400 mb-6">{{ $footerSettings->description ?? 'Developed with dermatologists, our skincare products help restore and maintain your skin\'s natural protective barrier.' }}</p>
                        <div class="flex space-x-4">
                            @if($footerSettings->facebook_url ?? null)
                                <a href="{{ $footerSettings->facebook_url }}" target="_blank" class="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full hover:bg-primary transition-colors">
                                    <i class="ri-facebook-fill"></i>
                                </a>
                            @endif
                            @if($footerSettings->instagram_url ?? null)
                                <a href="{{ $footerSettings->instagram_url }}" target="_blank" class="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full hover:bg-primary transition-colors">
                                    <i class="ri-instagram-line"></i>
                                </a>
                            @endif
                            @if($footerSettings->tiktok_url ?? null)
                                <a href="{{ $footerSettings->tiktok_url }}" target="_blank" class="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full hover:bg-primary transition-colors">
                                    <i class="ri-tiktok-line"></i>
                                </a>
                            @endif
                            @if($footerSettings->youtube_url ?? null)
                                <a href="{{ $footerSettings->youtube_url }}" target="_blank" class="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full hover:bg-primary transition-colors">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li><a href="{{ route('dr-c.chat') }}" class="text-gray-400 hover:text-white transition-colors">Dr. C Advisor</a></li>
                            <li><a href="{{ route('consultation-reports.my-report') }}" class="text-gray-400 hover:text-white transition-colors">Consultation</a></li>
                            <li><a href="{{ route('appointments.index') }}" class="text-gray-400 hover:text-white transition-colors">Appointments</a></li>
                            <li><a href="{{ url('/dashboard#skincare', [], false) }}" class="text-gray-400 hover:text-white transition-colors">Skincare</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li><a href="{{ route('consultation-reports.my-report') }}" class="text-gray-400 hover:text-white transition-colors">My Consultation</a></li>
                            <li><a href="{{ route('appointments.index') }}" class="text-gray-400 hover:text-white transition-colors">My Appointment</a></li>
                            <li><a href="{{ url('/dashboard#locate', [], false) }}" class="text-gray-400 hover:text-white transition-colors">Contact</a></li>
                        ...
                        <ul class="space-y-3">
                            @if($footerSettings->address ?? null)
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-400">{{ $footerSettings->address }}</span>
                                </li>
                            @endif
                            @if($footerSettings->phone ?? null)
                                <li class="flex items-center">
                                    <i class="ri-phone-line mr-3"></i>
                                    <span class="text-gray-400">{{ $footerSettings->phone }}</span>
                                </li>
                            @endif
                            @if($footerSettings->email ?? null)
                                <li class="flex items-center">
                                    <i class="ri-mail-line mr-3"></i>
                                    <span class="text-gray-400">{{ $footerSettings->email }}</span>
                                </li>
                            @endif
                        </ul>
                    </div>
                ...
                <div class="border-t border-gray-800 pt-8">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <p class="text-gray-400 text-sm mb-4 md:mb-0">{{ $footerSettings->copyright_text ?? '© 2025 CeraVe Malaysia. All rights reserved.' }}</p>
