...
<?php endif; ?>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <a href="<?php echo e(route('dashboard')); ?>" data-nav-section="dashboard" 
                    ...
                    <div x-show="open" 
                        ...
                        <div class="p-4 border-b border-gray-200">
                            <div class="flex items-center justify-between">
                                ...
                                <?php if($unreadCount > 0): ?>
                                    <a href="<?php echo e(route('notifications.markAllRead')); ?>" class="text-xs text-blue-600 hover:text-blue-800">Mark all read</a>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="max-h-96 overflow-y-auto">
                            <?php $__empty_1 = true; $__currentLoopData = Auth::user()->notifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <a href="<?php echo e($notification->data['report_url'] ?? '#'); ?>" 
                                   class="block p-4 hover:bg-gray-50 border-b border-gray-100 transition <?php echo e($notification->read_at ? 'bg-white' : 'bg-blue-50'); ?>">
                                    <div class="flex items-start gap-3">
                                        <div class="flex-shrink-0">
                                            <?php if(($notification->data['type'] ?? null) === 'consultation_report'): ?>
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-xs text-gray-600 mt-1"><?php echo e($notification->data['message'] ?? ''); ?></p>
...
<?php /**PATH C:\xampp\htdocs\cerave-system\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>