...
<head>
    ...
    <title>Consultation Report - <?php echo e($user->name); ?></title>
    <style>
        @media print {
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo e($user->phone ?? 'Not provided'); ?></div>
                    </div>
                    <div class="info-item">
                    ...
                    <?php if($user->birthday): ?>
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo e(\Carbon\Carbon::parse($user->birthday)->format('M d, Y')); ?></div>
                        </div>
                    <?php endif; ?>
                    <?php if($user->gender): ?>
                        <div class="info-item">
            ...
            <div class="section">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-value"><?php echo e($stats['total_appointments']); ?></div>
                        <div class="stat-label">Total Appointments</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value"><?php echo e($stats['completed_appointments']); ?></div>
                        <div class="stat-label">Completed</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value"><?php echo e($stats['total_dr_c_sessions']); ?></div>
                        <div class="stat-label">Dr. C Sessions</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value"><?php echo e($stats['total_consultations']); ?></div>
            ...
            <div class="section">
                ...
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo e($skinProfile['skin_type'] ? ucfirst($skinProfile['skin_type']) : 'Not specified'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Profile Last Updated</div>
                        <div class="info-value"><?php echo e($skinProfile['profile_updated_at'] ? $skinProfile['profile_updated_at']->format('M d, Y') : 'Never'); ?></div>
                    </div>
                </div>
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <div>
                            <?php $__currentLoopData = $skinProfile['skin_concerns']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($concern): ?>
                                    <span class="tag tag-orange"><?php echo e(ucfirst(trim($concern))); ?></span>
                                <?php endif; ?>
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <div>
                            <?php $__currentLoopData = $skinProfile['skin_conditions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $condition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($condition): ?>
                                    <span class="tag tag-red"><?php echo e(ucfirst(trim($condition))); ?></span>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <div>
                            <?php $__currentLoopData = $skinProfile['using_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($product): ?>
                                    <span class="tag tag-green"><?php echo e($product); ?></span>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
            ...
            <?php if($appointments->count() > 0): ?>
                <div class="section">
                    <h2 class="section-title">📅 Appointment History (<?php echo e($appointments->count()); ?>)</h2>
                    <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="appointment-item">
                            <div class="appointment-header">
                                <div>
                                    <div class="appointment-title"><?php echo e($appointment->name); ?></div>
                                    <div style="font-size: 13px; color: #6b7280; margin-top: 4px;">
                                        <?php echo e($appointment->email); ?> • <?php echo e($appointment->phone); ?>
                            ...
                            <div class="detail-row">
                                <div class="detail-item">
                                    ...
                                    <div class="detail-value"><?php echo e(\Carbon\Carbon::parse($appointment->preferred_date)->format('M d, Y')); ?> at <?php echo e($appointment->preferred_time); ?></div>
                                </div>
                                <div class="detail-item">
                                    <div class="detail-label">Type</div>
                                    <div class="detail-value"><?php echo e(ucfirst($appointment->consultation_type)); ?></div>
                                </div>
                                <?php if($appointment->location): ?>
                                    <div class="detail-item">
                                        <div class="detail-label">Location</div>
                                        <div class="detail-value"><?php echo e($appointment->location); ?></div>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <?php if($appointment->concerns): ?>
                                <div class="concerns-box">
                                    ...
                                    <div style="font-size: 14px; color: #374151;"><?php echo e($appointment->concerns); ?></div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($appointment->consultant_report): ?>
                                <div class="report-box">
                                    ...
                                    <div style="font-size: 14px; color: #374151;"><?php echo e($appointment->consultant_report); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($drCSessions->count() > 0): ?>
                <div class="section">
                    <h2 class="section-title">🤖 Dr. C AI Sessions (<?php echo e($drCSessions->count()); ?>)</h2>
                    <?php $__currentLoopData = $drCSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="appointment-item">
                            <div class="appointment-title">Session #<?php echo e($session->id); ?></div>
                            <div style="font-size: 13px; color: #6b7280; margin-top: 4px;">
                                <?php echo e($session->created_at->format('M d, Y g:i A')); ?> • <?php echo e($session->messages->count()); ?> messages
                            </div>
                            ...
                            <?php if($session->messages->count() > 0): ?>
                                <div class="concerns-box" style="margin-top: 15px;">
                                    ...
                                    <div style="font-size: 14px; color: #374151;"><?php echo e($session->messages->first()->message); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($consultations->count() > 0): ?>
                <div class="section">
                    <h2 class="section-title">💬 Consultation Records (<?php echo e($consultations->count()); ?>)</h2>
                    <?php $__currentLoopData = $consultations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consultation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="appointment-item">
                            <div style="font-size: 13px; color: #6b7280; margin-bottom: 12px;">
                                <?php echo e($consultation->created_at->format('M d, Y g:i A')); ?>
                            ...
                            <?php if($consultation->concerns): ?>
                                <div class="concerns-box">
                                    <div class="detail-label" style="margin-bottom: 8px;">Concerns</div>
                                    <div style="font-size: 14px; color: #374151;"><?php echo e($consultation->concerns); ?></div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($consultation->response): ?>
                                <div class="report-box" style="margin-top: 10px;">
                                    ...
                                    <div style="font-size: 14px; color: #374151;"><?php echo e($consultation->response); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="footer">
                ...
                <p>Consultation Report Generated on <?php echo e(now()->format('F d, Y')); ?></p>
...
<?php /**PATH C:\xampp\htdocs\cerave-system\resources\views/consultation-reports/pdf.blade.php ENDPATH**/ ?>