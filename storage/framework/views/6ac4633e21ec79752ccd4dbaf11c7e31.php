    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-1/2 bg-white flex items-center justify-center dark:bg-indigo-900">
            <div class="max-w-md w-full p-8">
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4" id="register-form">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input id="nickname" type="text" name="nickname" value="<?php echo e(old('nickname')); ?>"
                                class="w-full border p-2 rounded mt-1 block border-gray-300 focus:ring-blue-600 focus:border-blue-600 dark:bg-white dark:text-gray-800 dark:border-gray-200">
...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="text-center text-sm mt-4 dark:text-blue-200">Already have an account? <a href="<?php echo e(route('login')); ?>"
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cerave-system\resources\views/auth/register.blade.php ENDPATH**/ ?>