    ...
    <style>
        ...
        <section class="relative overflow-hidden">
            <video autoplay muted loop playsinline class="absolute inset-0 w-full h-full object-cover z-0">
                <source src="<?php echo e(asset('videos/CERAMIDES_MODULE_Video_Finalmp4.mp4')); ?>" type="video/mp4">
            </video>
            <div class="relative container mx-auto px-4 py-20 flex items-center">
                <div class="hero-gradient w-full md:w-1/2 p-10 rounded-lg">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo e(route('products.index')); ?>" class="bg-primary text-white px-8 py-3 !rounded-button font-medium whitespace-nowrap inline-flex items-center justify-center">Our
                            Products</a>
                        <button
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('products.show', $product->id, false)); ?>" class="block bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:shadow-lg hover:-translate-y-1 cursor-pointer dark:bg-gradient-to-br dark:from-slate-900 dark:to-indigo-950 dark:border dark:border-slate-800">
                            ...
                            <div class="p-6">
                                <div class="flex justify-between items-center mb-2">
                                    <span class="bg-blue-100 text-primary text-xs px-3 py-1 rounded-full dark:bg-blue-900 dark:text-blue-200"><?php echo e($product->category ?? 'Featured'); ?></span>
                                    <div class="flex">
                                        <?php for($i = 0; $i < 5; $i++): ?>
                                            <?php if($i < floor($product->rating ?? 4)): ?>
                                ...
                                <p class="text-gray-600 text-sm mb-4 dark:text-gray-300"><?php echo e(Str::limit(strip_tags($product->description), 50)); ?></p>
                            </div>
                        </a>
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <div class="lg:w-1/2">
                        ...
                        <form method="POST" action="<?php echo e(route('consultation.submit')); ?>" class="space-y-4 mt-6">
                            <?php echo csrf_field(); ?>
                        ...
                        <?php if(session('response')): ?>
                            <div class="mt-6 bg-blue-50 p-4 rounded shadow text-gray-800">
                                ...
                                <p><?php echo e(session('response')); ?></p>
                            </div>
                        <?php endif; ?>
                        <button
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <?php if(session('success')): ?>
                        <div class="fixed top-4 right-4 z-[9999] bg-green-50 border-l-4 border-green-500 p-4 rounded-lg shadow-2xl max-w-md">
                            <div class="flex items-center gap-3">
                                ...
                                <p class="text-green-700 font-medium"><?php echo e(strtoupper(session('success'))); ?></p>
                            </div>
                        </div>
                        <script>
                            setTimeout(() => {
                    ...
                    <div class="lg:w-1/2 bg-white rounded-xl shadow-lg p-6 dark:bg-gradient-to-br dark:from-slate-900 dark:to-indigo-950 dark:border dark:border-slate-800">
                        ...
                        <form id="appointmentForm" method="POST" action="<?php echo e(route('appointments.store')); ?>" class="space-y-4">
                            <?php echo csrf_field(); ?>
                            <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="date" class="block text-sm font-medium text-gray-700 mb-1 dark:text-blue-200">Preferred
                                        Date</label>
                                    <input type="date" id="date" name="preferred_date" value="<?php echo e(old('preferred_date')); ?>" required
                                        class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                                </div>
                                <div>
                                    <label for="time" class="block text-sm font-medium text-gray-700 mb-1 dark:text-blue-200">Preferred
                                        Time</label>
                                    <input type="time" id="time" name="preferred_time" value="<?php echo e(old('preferred_time')); ?>" required
                                        class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex space-x-4">
                                    <label class="flex items-center">
                                        <input type="radio" name="consultation_type" value="in-store"
                                            class="custom-radio" <?php if(old('consultation_type', 'in-store') === 'in-store'): echo 'checked'; endif; ?> required onchange="toggleLocation()">
                                        <span class="ml-2 text-gray-700 dark:text-blue-200">In-Store</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="consultation_type" value="online"
                                            class="custom-radio" <?php if(old('consultation_type') === 'online'): echo 'checked'; endif; ?> onchange="toggleLocation()">
                                        <span class="ml-2 text-gray-700 dark:text-blue-200">Online</span>
                                    </label>
                                </div>
                            </div>
                            <div id="locationField" style="display: <?php echo e(old('consultation_type', 'in-store') === 'in-store' ? 'block' : 'none'); ?>">
                                ...
                                <select name="location" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent dark:bg-slate-900 dark:border-slate-700 dark:text-white">
                                    ...
                                    <option value="SM Manila" <?php if(old('location') === 'SM Manila'): echo 'selected'; endif; ?>>SM Manila</option>
                                    <option value="SM Megamall" <?php if(old('location') === 'SM Megamall'): echo 'selected'; endif; ?>>SM Megamall</option>
                                    <option value="SM North EDSA" <?php if(old('location') === 'SM North EDSA'): echo 'selected'; endif; ?>>SM North EDSA</option>
                                    <option value="SM Makati" <?php if(old('location') === 'SM Makati'): echo 'selected'; endif; ?>>SM Makati</option>
                                    <option value="SM Aura" <?php if(old('location') === 'SM Aura'): echo 'selected'; endif; ?>>SM Aura</option>
                                    <option value="Ayala Malls Manila Bay" <?php if(old('location') === 'Ayala Malls Manila Bay'): echo 'selected'; endif; ?>>Ayala Malls Manila Bay</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <textarea id="concerns" name="concerns" data-section="concerns" rows="3"
                                    class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                                    placeholder="Please describe your skin concerns"><?php echo e(old('concerns')); ?></textarea>
                            </div>
                            <button type="submit"
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cerave-system\resources\views/dashboard.blade.php ENDPATH**/ ?>