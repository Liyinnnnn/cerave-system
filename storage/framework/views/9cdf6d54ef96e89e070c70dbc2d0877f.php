...
<div class="bg-white border-b border-gray-200 shadow-sm sticky top-16 z-40 dark:bg-slate-900 dark:border-slate-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex items-center gap-3 text-sm py-3 text-gray-800 dark:text-gray-200">
            ...
            <span>&gt;</span>
            <span class="text-gray-500 dark:text-gray-400">Appointment #<?php echo e($appointment->id); ?></span>
        </nav>
    </div>
</div>
        ...
        <div class="bg-white rounded-xl shadow-2xl overflow-hidden dark:bg-gradient-to-br dark:from-slate-900 dark:to-indigo-950 dark:border dark:border-slate-800">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 p-4 dark:from-blue-800 dark:to-indigo-900">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-xl font-bold text-white mb-1">Appointment #<?php echo e($appointment->id); ?></h1>
                        <p class="text-sm text-blue-100"><?php echo e($appointment->name); ?></p>
                    </div>
                    <span class="px-3 py-1.5 rounded-full text-xs font-semibold
                        <?php if($appointment->status === 'pending'): ?> bg-yellow-100 text-yellow-800
                        <?php elseif($appointment->status === 'confirmed'): ?> bg-green-100 text-green-800
            ...
            <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div class="flex items-start p-3 bg-blue-50 rounded-lg dark:bg-indigo-900 dark:bg-opacity-30 dark:border dark:border-indigo-700">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-gray-800 dark:text-white"><?php echo e(\Carbon\Carbon::parse($appointment->preferred_date)->format('l, F d, Y')); ?></p>
                            </div>
                        </div>
                        <div class="flex items-start p-3 bg-blue-50 rounded-lg dark:bg-indigo-900 dark:bg-opacity-30 dark:border dark:border-indigo-700">
                            <svg class="w-4 h-4 mr-2 text-primary mt-0.5 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-gray-800 dark:text-white"><?php echo e(\Carbon\Carbon::parse($appointment->preferred_time)->format('g:i A')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div class="flex items-center p-3 border border-gray-200 rounded-lg dark:border-slate-700">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-800 dark:text-white"><?php echo e($appointment->email); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center p-3 border border-gray-200 rounded-lg dark:border-slate-700">
                            <svg class="w-4 h-4 mr-2 text-gray-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-800 dark:text-white"><?php echo e($appointment->phone); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <p class="px-3 py-2 bg-blue-100 text-blue-800 rounded-lg inline-block text-sm font-semibold dark:bg-blue-900 dark:text-blue-200">
                            <?php echo e(ucfirst($appointment->consultation_type)); ?> Consultation
                        </p>
                        <?php if($appointment->consultation_type === 'in-store' && $appointment->location): ?>
                            <p class="px-3 py-2 bg-blue-100 text-blue-800 rounded-lg inline-block text-sm font-semibold dark:bg-blue-900 dark:text-blue-200">
                                Location: <?php echo e($appointment->location); ?>
                ...
                <?php if(auth()->user()->isAdmin() || auth()->user()->isConsultant()): ?>
                    <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200 p-4 dark:from-slate-800 dark:to-slate-700 dark:border-purple-600">
                        ...
                        <form method="POST" action="<?php echo e(route('appointments.update', $appointment)); ?>" class="flex flex-col md:flex-row gap-3 items-end">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="flex-1">
                                ...
                                <select name="consultant_id" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-purple-500 focus:border-purple-500 transition bg-white dark:bg-slate-900 dark:border-slate-600 dark:text-white">
                                    ...
                                    <?php $__currentLoopData = $consultants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consultant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($consultant->id); ?>" <?php if(old('consultant_id', $appointment->consultant_id) === $consultant->id): echo 'selected'; endif; ?>>
                ...
                <?php if($appointment->concerns): ?>
                    <div>
                        ...
                        <div class="p-3 bg-gray-50 rounded-lg border border-gray-200 dark:bg-slate-800 dark:bg-opacity-50 dark:border-slate-700">
                            <p class="text-sm text-gray-700 leading-relaxed dark:text-blue-200"><?php echo e($appointment->concerns); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if(auth()->user()->isAdmin() || auth()->user()->isConsultant()): ?>
                    <div class="border-t border-gray-200 pt-4 dark:border-slate-700">
                        ...
                        <?php if((auth()->user()->isConsultant() || auth()->user()->isAdmin()) && !$appointment->report_generated_at): ?>
                        ...
                        <?php elseif($appointment->report_generated_at): ?>
                            <div class="mb-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4 dark:from-slate-800 dark:to-slate-700 dark:border-blue-700">
                                ...
                                <p class="text-sm text-gray-700 mb-3 dark:text-gray-300">
                                    Report generated <?php echo e($appointment->report_generated_at->diffForHumans()); ?> by <?php echo e($appointment->consultant->name ?? 'Consultant'); ?>

                                </p>
                                <a href="<?php echo e(route('appointments.report', $appointment)); ?>" target="_blank" class="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold shadow-md dark:bg-blue-700 dark:hover:bg-blue-800">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Report Status Badge -->
                        <?php if($appointment->report_status !== 'draft'): ?>
                            <div class="mb-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-3 dark:from-slate-800 dark:to-slate-700 dark:border-blue-700">
                                <div class="flex items-center gap-3 flex-wrap text-sm">
                                    <span class="px-3 py-1 rounded text-xs font-semibold
                                        <?php if($appointment->report_status === 'pending_approval'): ?> bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200
                                        <?php elseif($appointment->report_status === 'approved'): ?> bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200
                                        <?php elseif($appointment->report_status === 'rejected'): ?> bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200
                                        <?php endif; ?>">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $appointment->report_status))); ?>

                                    </span>
                                    <?php if($appointment->report_submitted_at): ?>
                                        <span class="text-xs text-gray-600 dark:text-gray-300">
                                            Submitted <?php echo e($appointment->report_submitted_at->diffForHumans()); ?> by <?php echo e($appointment->reportSubmitter->name ?? 'Unknown'); ?>

                                        </span>
                                    <?php endif; ?>
                                    <?php if($appointment->report_approved_at && $appointment->report_status === 'approved'): ?>
                                        <span class="text-xs text-gray-600 dark:text-gray-300">
                                            | Approved <?php echo e($appointment->report_approved_at->diffForHumans()); ?>
                                ...
                                <?php if($appointment->admin_feedback): ?>
                                    <div class="mt-2 p-2 bg-white rounded border-l-2 border-blue-500 dark:bg-slate-800 dark:border-blue-400">
                                        ...
                                        <p class="text-xs text-gray-700 dark:text-gray-300"><?php echo e($appointment->admin_feedback); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                        ...
                        <form id="appointmentForm" method="POST" action="<?php echo e(route('appointments.update', $appointment)); ?>" class="space-y-4">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="solution" rows="3" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition dark:bg-slate-900 dark:border-slate-700 dark:text-white" placeholder="Describe treatment plan..." <?php if($appointment->report_status === 'approved'): ?> readonly <?php endif; ?>><?php echo e(old('solution', $appointment->solution)); ?></textarea>
                                </div>

                                <!-- AI Suggestion -->
                                <div>
                                    <label class="block text-xs font-semibold text-gray-700 mb-1 dark:text-blue-200">AI Suggestion</label>
                                    <textarea name="ai_suggestion" rows="3" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg bg-blue-50 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition dark:bg-slate-800 dark:border-slate-700 dark:text-white" placeholder="AI suggestions..." <?php if($appointment->report_status === 'approved'): ?> readonly <?php endif; ?>><?php echo e(old('ai_suggestion', $appointment->ai_suggestion)); ?></textarea>
                                </div>

                                <!-- Consultant Notes -->
                                <div class="md:col-span-2">
                                    <label class="block text-xs font-semibold text-gray-700 mb-1 dark:text-blue-200">Consultant Notes</label>
                                    <textarea name="consultant_notes" rows="3" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition dark:bg-slate-900 dark:border-slate-700 dark:text-white" placeholder="Add detailed notes..." <?php if($appointment->report_status === 'approved'): ?> readonly <?php endif; ?>><?php echo e(old('consultant_notes', $appointment->consultant_notes)); ?></textarea>
                                </div>

                                <!-- Suggested Products -->
                                <div>
                                    <label class="block text-xs font-semibold text-gray-700 mb-1 dark:text-blue-200">Suggested Products</label>
                                    <select class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition bg-white mb-1 dark:bg-slate-900 dark:border-slate-700 dark:text-white" onchange="addProduct(this)" <?php if($appointment->report_status === 'approved'): ?> disabled <?php endif; ?>>
                                        <option value="">-- Select product --</option>
                                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($product->name); ?>"><?php echo e($product->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <textarea name="suggested_products" id="suggested_products" rows="3" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition dark:bg-slate-900 dark:border-slate-700 dark:text-white" placeholder="- Product 1&#10;- Product 2" <?php if($appointment->report_status === 'approved'): ?> readonly <?php endif; ?>><?php echo e(old('suggested_products', $appointment->suggested_products)); ?></textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-1 mb-1">
                                        <button type="button" onclick="insertTemplate('morning')" class="px-2 py-1 bg-blue-100 text-blue-700 rounded text-[10px] font-medium hover:bg-blue-200 transition dark:bg-blue-900 dark:text-blue-200" <?php if($appointment->report_status === 'approved'): ?> disabled <?php endif; ?>>Morning</button>
                                        <button type="button" onclick="insertTemplate('night')" class="px-2 py-1 bg-indigo-100 text-indigo-700 rounded text-[10px] font-medium hover:bg-indigo-200 transition dark:bg-indigo-900 dark:text-indigo-200" <?php if($appointment->report_status === 'approved'): ?> disabled <?php endif; ?>>Night</button>
                                        <button type="button" onclick="insertTemplate('weekly')" class="px-2 py-1 bg-purple-100 text-purple-700 rounded text-[10px] font-medium hover:bg-purple-200 transition dark:bg-purple-900 dark:text-purple-200" <?php if($appointment->report_status === 'approved'): ?> disabled <?php endif; ?>>Weekly</button>
                                    </div>
                                    <textarea name="usage_instructions" id="usage_instructions" rows="3" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition dark:bg-slate-900 dark:border-slate-700 dark:text-white" placeholder="Usage steps..." <?php if($appointment->report_status === 'approved'): ?> readonly <?php endif; ?>><?php echo e(old('usage_instructions', $appointment->usage_instructions)); ?></textarea>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="flex gap-2 mb-1">
                                        <select class="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition bg-white dark:bg-slate-900 dark:border-slate-700 dark:text-white" onchange="addPurchasedProduct(this)" <?php if($appointment->report_status === 'approved'): ?> disabled <?php endif; ?>>
                                            <option value="">-- Select purchased --</option>
                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($product->name); ?>"><?php echo e($product->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <input type="number" id="product_quantity" min="1" value="1" class="w-16 px-2 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition dark:bg-slate-900 dark:border-slate-700 dark:text-white" <?php if($appointment->report_status === 'approved'): ?> disabled <?php endif; ?>>
                                    </div>
                                    <textarea name="purchased_products" id="purchased_products" rows="3" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition dark:bg-slate-900 dark:border-slate-700 dark:text-white" placeholder="- Product (x1)&#10;- Product (x2)" <?php if($appointment->report_status === 'approved'): ?> readonly <?php endif; ?>><?php echo e(old('purchased_products', $appointment->purchased_products)); ?></textarea>
                                </div>
                            </div>

                            <?php if($appointment->report_status !== 'approved'): ?>
                                <div class="border-t border-gray-200 pt-4 dark:border-slate-700">
    ...
    textarea.focus();
                        ...
                        <div class="border-t border-gray-200 pt-4 dark:border-slate-700">
                            <div class="flex gap-2 flex-wrap">
                                ...
                                <?php if(auth()->user()->isConsultant() && $appointment->report_status === 'draft'): ?>
                                    <form method="POST" action="<?php echo e(route('appointments.submitReport', $appointment)); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php if(auth()->user()->isAdmin() && $appointment->report_status === 'pending_approval'): ?>
                                    <form method="POST" action="<?php echo e(route('appointments.approveReport', $appointment)); ?>" class="inline" onsubmit="return confirm('Approve this report?');">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php if($appointment->status === 'pending'): ?>
                                    <form method="POST" action="<?php echo e(route('appointments.update', $appointment)); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                ...
                                <?php if(auth()->user()->isAdmin()): ?>
                                    <form method="POST" action="<?php echo e(route('appointments.destroy', $appointment)); ?>" class="inline" onsubmit="return confirm('Delete this appointment?');">
                                        <?php echo csrf_field(); ?>
...
<div id="rejectModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full dark:bg-slate-900">
        <div class="p-6">
            ...
            <form method="POST" action="<?php echo e(route('appointments.approveReport', $appointment)); ?>">
                <?php echo csrf_field(); ?>
...
<div id="reportFormModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
    <div class="bg-white rounded-xl shadow-2xl max-w-4xl w-full my-8 dark:bg-slate-900">
        <form method="POST" action="<?php echo e(route('appointments.generateReport', $appointment)); ?>">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-2 max-h-48 overflow-y-auto p-3 border border-gray-200 rounded-lg dark:border-slate-700">
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-start gap-3 p-2 hover:bg-blue-50 rounded cursor-pointer dark:hover:bg-slate-800">
                                    <input type="checkbox" name="recommended_products[]" value="<?php echo e($product->id); ?>" class="mt-1 w-4 h-4 text-green-600 border-gray-300 rounded focus:ring-green-500">
                                    <div class="flex-1">
                                        <p class="text-sm font-semibold text-gray-800 dark:text-white"><?php echo e($product->name); ?></p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($product->category); ?></p>
                                    </div>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cerave-system\resources\views/appointments/show.blade.php ENDPATH**/ ?>