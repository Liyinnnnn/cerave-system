    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-1/2 bg-white flex items-center justify-center">
            <div class="max-w-md w-full p-8">
                ...
                <?php if(session('mail_error')): ?>
                    <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-lg">
                        <p class="text-red-700 font-medium"><?php echo e(session('mail_error')); ?></p>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cerave-system\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>