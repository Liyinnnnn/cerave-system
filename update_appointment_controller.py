...
# Create a targeted replacement for the manage method
old_section = '''    public function manage(Request $request)
    {
        $user = $request->user();
...
new_section = '''    public function manage(Request $request)
    {
        $user = $request->user();
...
print('AppointmentController manage method updated successfully')
